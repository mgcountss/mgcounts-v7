...
let id = "572107827020300288";
let id2 = "BlueGhostGamer";
let last = []
document.getElementById('search1').value = id2
document.getElementById('search2').value = id
...
let lastest = 0;
function fetcher() {
    fetch('https://backend.mgcounts.com/discord/mee6/' + id + '/' + id2 + '')
